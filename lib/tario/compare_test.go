...
func TestIsSimilar(t *testing.T) {
	t.Run("DirAndFileConsideredDifferent", func(t *testing.T) {
		...
		require.NoError(err)
		similar, err := IsSimilarHeader(h, newH, false)
...
func TestIsSimilarHardlink(t *testing.T) {
	t.Run("NoChange", func(t *testing.T) {
		...
		newH.Linkname = testFile.Name()
		newH.Size = 0
		similar, err := isSimilarHardLink(h, newH, false)
		require.True(similar)
		require.NoError(err)
		similar, err = IsSimilarHeader(h, newH, false)
		require.True(similar)
...
func TestIsSimilarDirectory(t *testing.T) {
	t.Run("NoChange", func(t *testing.T) {
		...
		newH, err := tar.FileInfoHeader(fi2, "")
		require.NoError(err)
		similar, err := isSimilarDirectory(h, newH, false)
		require.True(similar)
		require.NoError(err)
		similar, err = IsSimilarHeader(h, newH, false)
		require.True(similar)
	...
	t.Run("DifferentModTimeConsideredSimilarIfIgnored", func(t *testing.T) {
		require := require.New(t)
		...
		newH, err := tar.FileInfoHeader(fi2, "")
		require.NoError(err)
		similar, err := isSimilarDirectory(h, newH, true)
		require.True(similar)
		require.NoError(err)
		similar, err = IsSimilarHeader(h, newH, true)
		require.True(similar)
		require.NoError(err)
	})
...
func TestIsSimilarRegularFile(t *testing.T) {
	t.Run("NoChange", func(t *testing.T) {
		...
		newH, err := tar.FileInfoHeader(fi2, "")
		require.NoError(err)
		similar, err := isSimilarRegularFile(h, newH, false)
		require.True(similar)
		require.NoError(err)
		similar, err = IsSimilarHeader(h, newH, false)
		require.True(similar)
	...
	t.Run("DifferentModTimeConsideredSimilarIfIgnored", func(t *testing.T) {
		...
		newH, err := tar.FileInfoHeader(fi2, "")
		require.NoError(err)
		similar, err := isSimilarRegularFile(h, newH, true)
		require.True(similar)
		require.NoError(err)
		similar, err = IsSimilarHeader(h, newH, true)
		require.True(similar)
